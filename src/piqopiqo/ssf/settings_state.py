...
class RuntimeSettingKey(StrEnum):
    ...
    FLICKR_API_HEAVY_TIMEOUT_S = "flickrApiHeavyTimeoutS"
    FLICKR_API_VERY_LONG_TIMEOUT_S = "flickrApiVeryLongTimeoutS"
    ...
    FULLSCREEN_INFO_PANEL_SWATCH_BORDER_COLOR = "fullscreenInfoPanelSwatchBorderColor"
    FULLSCREEN_INFO_PANEL_SWATCH_BORDER_WIDTH = "fullscreenInfoPanelSwatchBorderWidth"
...
_RUNTIME_SETTING_REGISTRY: dict[RuntimeSettingKey, SettingDef] = {
    ...
    RuntimeSettingKey.FLICKR_API_QUICK_TIMEOUT_S: SettingDef(
        default=5.0,
        read_type=float,
    ),
    RuntimeSettingKey.FLICKR_API_HEAVY_TIMEOUT_S: SettingDef(
        default=30.0,
        read_type=float,
    ),
    RuntimeSettingKey.FLICKR_API_VERY_LONG_TIMEOUT_S: SettingDef(
        default=120.0,
        read_type=float,
    ),
    ...
    RuntimeSettingKey.FULLSCREEN_INFO_PANEL_SWATCH_BORDER_COLOR: SettingDef(
        default="white", read_type=str
    ),
    RuntimeSettingKey.FULLSCREEN_INFO_PANEL_SWATCH_BORDER_WIDTH: SettingDef(
        default=1, read_type=int
    ),
