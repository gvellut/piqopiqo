...
<Multiple Values> :L when starting editing focus on field => must go blank directly

Time taken : multiple values => Go red border : bad validation ? Seems to be fine for latlon.