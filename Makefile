...
RUST_LIB = $(CORE_LIB_DIR)/target/release/libcore_lib.a

# FFI artifacts
# Source path of the header generated by the build.rs script
SRC_C_HEADER = $(CORE_LIB_DIR)/target/release/core_lib.h
...
$(SWIFT_EXE): $(RUST_LIB)
	...
	(cd $(GUI_APP_DIR) && swift build -c release)
