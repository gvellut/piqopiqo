...
- If `Config.GRID_LOWRES_ONLY` is true, HQ thumbnails are skipped in both scheduling and grid display logic; this mode is intended for debugging low-res placeholder behavior.
