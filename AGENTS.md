...
- Flickr album reorder result summaries show up to eight lines at a fixed height. Reserve one additional text line so a horizontal scrollbar does not clip the last visible line.
