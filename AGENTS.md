...
- Settings > External/Workflow uses app-path selectors. On macOS, Browse starts in `/Applications` when empty, or in the parent folder of the currently configured `.app`.
